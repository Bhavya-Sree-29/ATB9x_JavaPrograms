...
public class Lab064 {
    public static void main(String[] args) {
        ...
        //5. .concat()
        System.out.println(string.concat(" Koduri")); // Concatenates another string

        //6. .indexOf(char ch, int fromIndex)
        System.out.println(string.indexOf("i", 3)); // Finds index of 'r' starting from index 3
        ...
        System.out.println(string.equalsIgnoreCase("Akhil")); // Case-insensitive equality check

        //15. .isEmpty()
        System.out.println(string.isEmpty()); // Checks if string is empty

        //16. .contains(CharSequence sequence)
        System.out.println(string.contains("hil")); // Checks if string contains "shu"
        ...
        //18. .trim()
        String strWithSpaces = "   Akhil   ";
        System.out.println(strWithSpaces.trim()); // Removes leading and trailing whitespaces

        //19. .compareTo(String anotherString)
        System.out.println(string.compareTo("Akhil")); // Compares lexicographically

        //20. .compareToIgnoreCase(String anotherString)
        System.out.println(string.compareToIgnoreCase("Akhil")); // Case-insensitive comparison
        ...
        System.out.println(string.lastIndexOf("i")); // Finds last occurrence of "r"
